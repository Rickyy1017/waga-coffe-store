    ...
    >
      ...
      <CardContent className="p-6">
        <div className="flex justify-between items-start mb-3">
          <h4 className="font-semibold text-xl text-white group-hover:text-white transition-colors">
            {product.name}
          </h4>
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-right">
            <div className="font-bold text-xl text-white group-hover:text-white transition-colors">
              ${product.priceUsd}
            </div>
            <div className="text-sm text-white/70 group-hover:text-white/90 transition-colors">
