    ...
    <Web3Background pattern="blockchain" intensity="low">
      ...
      <div className=" mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center  mb-12">
          <h1 className="lg:text-4xl text-2xl md:text-6xl font-bold mb-6 text-white">
            Ethiopia: The Birthplace of Coffee
          </h1>
          <p className="text-sm md:text-2xl max-w-3xl mx-auto text-white">
            Order premium coffee beans, straight from the source, the lush highlands of Ethiopia where coffee cultivation began over a thousand years ago.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-8xl mx-auto">

          <Card className="shadow-lg relative overflow-hidden" style={{backgroundImage: 'url(/images/coffebg.jpg)', backgroundSize: 'cover', backgroundPosition: 'center'}}>
            <div className="absolute inset-0 bg-black/40"></div>
            <div className="relative z-10 p-6">
              <CardHeader className="pb-4">
                <CardTitle className="text-xl lg:text-4xl font-bold text-white">Our Ethiopian Heritage</CardTitle>
              </CardHeader>
              <CardContent className="lg:text-xl space-y-3 p-0">
                ...
                <ul className="list-disc font-semibold list-inside space-y-2 text-sm lg:text-xl mt-8 text-white">
