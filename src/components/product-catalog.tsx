    ...
    <section className="py-20 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        <div className="text-center mb-16 animate-slide-in-up">
          <h3 className="font-bold  text-3xl md:text-4xl text-white mb-10">
            Featured <span className="text-white/80 ">Coffee Collection</span>
          </h3>
          ...
          {isLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[...Array(6)].map((_, i) => (
                <Card key={i} className="overflow-hidden card-web3 animate-pulse bg-white/10 backdrop-blur-lg border-white/20">
