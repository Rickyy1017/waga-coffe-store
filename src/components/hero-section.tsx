...
export function HeroSection() {
  return (
    <Web3Background pattern="blockchain" intensity="low">
      <section id="home" className="relative py-20 bg-[#032524e7] backdrop-blur-md border border-white/30 text-white overflow-hidden">
        ...
        {/* <h1 className="font-bold flex mb-4 m-auto justify-center">
          <img
            src="/images/WAGA.jpg"
            alt="WAGA Coffee Store"
            className="w-44 rounded-lg mr-2 object-cover bg-contain "
          />
        </h1> */}
        ...
        <div className="relative z-20 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p
              className="text-xl md:text-2xl mb-8 text-coffee-cream max-w-3xl mx-auto animate-slide-in-up"
            ...
            >
              <span className="text-2xl font-semibold text-coffee-cream/80 mb-4 block">
                We Accept:
              </span>
              ...
              <div className="flex justify-center items-center space-x-6 md:space-x-8 text-coffee-cream">
                ...
                <div className="">
                  <IoLogoUsd className=" h-10 bg-blue-600 rounded-full w-10 mx-auto" />
                ...
                <div className="flex items-center flex-col">
                  <FaMoneyBillTransfer className=" h-10 w-10 text-blue-400 " />
                  <span className="block text-sm mt-1 font-semibold ">
                    Bank Transfer
                  </span>
                </div>
