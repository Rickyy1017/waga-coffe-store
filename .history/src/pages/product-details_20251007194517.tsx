          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center bg-[#032524]/10 px-3 py-1 rounded-full">
                  <Star className="h-5 w-5 text-[#032524] fill-current" />
            ...
            {/* Description */}
            <Card className="border-[#032524]/20 shadow-lg">
              <CardContent className="p-6">
                <h3 className="font-bold text-xl text-gray-900 mb-3 flex items-center">
                  <Coffee className="h-5 w-5 mr-2 text-[#032524]" />
                  About This Coffee
                </h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card className="border-[#032524]/20 shadow-lg">
                <CardContent className="p-4 text-center">
                  <MapPin className="h-8 w-8 text-[#032524] mx-auto mb-2" />
                  <h4 className="font-bold text-gray-900 mb-1">Origin</h4>
              ...
              <Card className="border-[#032524]/20 shadow-lg">
                <CardContent className="p-4 text-center">
                  ...
                  <h4 className="font-bold text-gray-900 mb-1">Process</h4>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <Button
                  ...
                  variant="outline"
                  className="h-14 text-lg font-bold border-2 border-[#032524] text-[#032524] hover:bg-[#032524]/10 shadow-lg hover:shadow-xl transition-all duration-300"
            ...
            {/* Trust Indicators */}
            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-[#032524]/20">
              <div className="text-center">
