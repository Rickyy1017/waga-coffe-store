        ...
        <div className="bg-white/20 backdrop-blur-lg border border-white/30 rounded-3xl p-8 md:p-12">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-6 mt-12">
              <div className="bg-green-400/10 backdrop-blur-lg border border-green-400/30 rounded-lg p-4 hover:bg-green-400/20 transition-colors">
              ...
              <div className="bg-red-400/10 backdrop-blur-lg border border-red-400/30 rounded-lg p-4 hover:bg-red-400/20 transition-colors">
