  ...
  return (
    <section className="py-20 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white/30 backdrop-blur-lg rounded-3xl p-8 md:p-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <Badge className="mb-4 bg-white/30 backdrop-blur-lg">
              Our Story
            </Badge>
            <h2 className="text-4xl font-bold text-white mb-6 bg-white/30 backdrop-blur-lg rounded-lg p-4 inline-block">
              Crafting Exceptional Coffee Since 2018
            </h2>
            <p className="text-lg text-white/80 mb-6 bg-white/30 backdrop-blur-lg rounded-lg p-4">
            ...
            <p className="text-lg text-white/80 mb-8 bg-white/30 backdrop-blur-lg rounded-lg p-4">
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              <div className="text-center bg-white/30 backdrop-blur-lg rounded-lg p-4">
            ...
            <Button className="bg-white/30 backdrop-blur-lg hover:bg-white/40">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-6">
              <div className="bg-white/30 backdrop-blur-lg rounded-lg p-4 hover:bg-white/40 transition-colors">
            ...
            <div className="space-y-6 mt-12">
              <div className="bg-white/20 backdrop-blur-sm border border-white/30 rounded-lg p-4 hover:bg-white/30 transition-colors">
