      ...
      <div className=" mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-8xl mx-auto">
          ...
          <Card className="shadow-lg">
            <CardHeader>
              <CardTitle className="text-xl lg:text-4xl font-bold">Our Ethiopian Heritage</CardTitle>
            </CardHeader>
            <CardContent className="lg:text-xl space-y-4">
              <p className="text-lg">
              ...
              <ul className="list-disc font-semibold list-inside space-y-2 text-base">
