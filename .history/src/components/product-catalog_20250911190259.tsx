      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          <div className="text-center mb-16 animate-slide-in-up">
            <h1 className=" absolute top-[-4.5%] left-0 hidden lg:text-8xl tracking-[15px] capitalize w-full " style={{ color: "transparent", WebkitTextStroke: ".5px #032524" }} >our Collection</h1>
