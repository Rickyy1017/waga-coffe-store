      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          <div className="text-center mb-16 animate-slide-in-up">
            <h1 className=" absolute text-7xl lg:top-[-4.5%] lg:left-0 lg:text-8xl capitalize  w-full z-10 " style={{ color: "transparent", WebkitTextStroke: "px #032524" }} >our Collection</h1>
