        ...
        <div className="bg-white/20 backdrop-blur-lg border border-white/30 rounded-3xl p-8 md:p-12">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-6">
              <div className="bg-white/10 backdrop-blur-lg border border-amber-400/30 rounded-lg p-4 hover:bg-white/20 transition-colors">
              ...
              <div className="bg-white/10 backdrop-blur-lg border border-blue-400/30 rounded-lg p-4 hover:bg-white/20 transition-colors">
