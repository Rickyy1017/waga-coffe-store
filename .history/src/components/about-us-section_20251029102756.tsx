      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-transparent backdrop-blur-md rounded-3xl p-8 md:p-12">
          ...
          <div>
            ...
            <h2 className="text-4xl font-bold text-white mb-6 bg-transparent backdrop-blur-sm border border-white/30 rounded-lg p-4 inline-block">
              Crafting Exceptional Coffee Since 2018
            </h2>
            <p className="text-lg text-white/80 mb-6 bg-transparent backdrop-blur-sm border border-white/30 rounded-lg p-4">
            ...
            <p className="text-lg text-white/80 mb-8 bg-transparent backdrop-blur-sm border border-white/30 rounded-lg p-4">
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              <div className="text-center bg-transparent backdrop-blur-sm border border-white/30 rounded-lg p-4">
