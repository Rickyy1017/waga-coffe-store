...
export function AboutUsSection() {
  return (
    <section className="py-20 relative about-us-section">
        ...
        <div className="bg-white/20 backdrop-blur-lg border border-white/30 rounded-3xl p-8 md:p-12">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-6">
              <div className="bg-amber-500/20 border border-amber-400/30 rounded-lg p-4 hover:bg-amber-500/30 transition-colors">
              ...
              <div className="bg-blue-500/20 border border-blue-400/30 rounded-lg p-4 hover:bg-blue-500/30 transition-colors">
            ...
            <div className="space-y-6 mt-12">
              <div className="bg-green-500/20 border border-green-400/30 rounded-lg p-4 hover:bg-green-500/30 transition-colors">
              ...
              <div className="bg-red-500/20 border border-red-400/30 rounded-lg p-4 hover:bg-red-500/30 transition-colors">
