...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Card
      className="card-web3 hover-lift overflow-hidden group cursor-pointer"
    ...
    >
      <div className="aspect-[4/3] overflow-hidden relative">
        ...
        <div className="absolute top-3 left-3 flex flex-col gap-2">
          <Badge className="bg-accent-blue/90 backdrop-blur-sm border-0 animate-pulse-glow">
          ...
          {product.badges && product.badges.map((badge, index) => (
            <Badge
              ...
              className={`text-xs font-semibold ${
                ...
                badge === 'Premium' ? 'bg-yellow-500 text-black' :
                badge === 'Organic' ? 'bg-green-600 text-white' :
      ...
      <CardContent className="p-6">
        ...
        <div className="flex align-middle items-center justify-between gap-2 mb-4">
          ...
          <Button
            ...
            className="btn-web3  transform scale-90 group-hover:scale-100 transition-transform duration-300"
          >
            {isAdding ? (
