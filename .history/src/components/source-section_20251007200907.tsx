      ...
      <div className=" mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <Card className="shadow-lg">
            <CardHeader>
              <CardTitle className="text-lg lg:text-3xl font-bold">Our Ethiopian Heritage</CardTitle>
            </CardHeader>
            <CardContent className="lg:text-lg space-y-3">
              <p>
              ...
              <ul className="list-disc font-semibold list-inside space-y-1 text-sm">
          ...
          <Card className="shadow-lg">
            ...
            <CardContent>
              <div className="aspect-[4/3]">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d156494.34831439753!2d38.62225209678101!3d8.96331380277265!2m3!1f0!2f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x164b85cef5ab402d%3A0x8467b6b037a24d49!2sAddis%20Ababa%2C%20Ethiopia!5e1!3m2!1sen!2sng!4v1757663119652!5m2!1sen!2sng"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
