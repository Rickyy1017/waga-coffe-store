  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute top-10 left-10 animate-float" style={{ animationDelay: '0.5s' }}>
        <div className="crypto-coin eh w-6 h-6" />
      </div>
      <div className="absolute top-20 right-20 animate-float" style={{ animationDelay: '1s' }}>
        <div className="crypto-coin usdc w-8 h-8" />
      </div>
      <div className="absolute bottom-10 left-20 animate-float" style={{ animationDelay: '1.5s' }}>
        <div className="crypto-coin w-5 h-5" />
      </div>
      <div className="absolute bottom-20 right-10 animate-float" style={{ animationDelay: '2s' }}>
        <div className="crypto-coin eth w-7 h-7" />
      </div>
    </div>
  );
}
