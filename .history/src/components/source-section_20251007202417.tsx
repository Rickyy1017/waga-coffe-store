      ...
      <div className=" mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-8xl mx-auto">
          ...
          <Card className="shadow-lg">
            <CardHeader>
              <CardTitle className="text-2xl lg:text-5xl font-bold">Our Ethiopian Heritage</CardTitle>
            </CardHeader>
            <CardContent className="lg:text-2xl space-y-4">
              ...
              <ul className="list-disc font-semibold list-inside space-y-2 text-sm lg:text-2xl mt-12">
