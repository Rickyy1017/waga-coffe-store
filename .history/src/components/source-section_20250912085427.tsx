    ...
    <section className="py-20 bg-coffee-cream text-[#032524]">
      <div className=" mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center  mb-12">
          <h1 className="lg:text-4xl text-3xl md:text-6xl font-bold mb-6">
            Ethiopia: The Birthplace of Coffee
          </h1>
          <p className="text-xl md:text-2xl max-w-3xl mx-auto">
            Order  premium coffee beans, straight from the source, the
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 ">
          ...
          <Card className="shadow-lg">
            <CardHeader>
              <CardTitle className="text-3xl lg:text-5xl font-bold">Our Ethiopian Heritage</CardTitle>
            </CardHeader>
            <CardContent className="text-2xl space-y-4">
              <p>
