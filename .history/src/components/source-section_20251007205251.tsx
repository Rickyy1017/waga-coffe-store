          ...
          <Card className="shadow-lg relative overflow-hidden" style={{backgroundImage: 'url(/images/coffebg.jpg)', backgroundSize: 'cover', backgroundPosition: 'center'}}>
            ...
            <div className="relative z-10 p-6">
              <CardHeader className="pb-4">
                <CardTitle className="text-2xl lg:text-5xl font-bold text-white">Our Ethiopian Heritage</CardTitle>
              </CardHeader>
              <CardContent className="lg:text-2xl space-y-4 p-0">
                ...
                <ul className="list-disc font-semibold list-inside space-y-2 text-sm lg:text-2xl mt-12 text-white">
