        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              {wallet.isConnected ? (
                <div className="hidden md:flex items-center px-4 py-2 bg-green-500 text-white rounded-lg">
                ...
                <Button
                  ...
                  className="text-white cursor-pointer md:flex items-center bg-red-500 hover:bg-red-600"
                >
                  <Wallet className="mr-2 h-4 w-4" />
                  Connect Wallet
                </Button>
