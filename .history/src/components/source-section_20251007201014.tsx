        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <Card className="shadow-lg p-4">
            <CardHeader className="pb-3">
              <CardTitle className="text-lg lg:text-2xl font-bold">Our Ethiopian Heritage</CardTitle>
            </CardHeader>
            <CardContent className="lg:text-base space-y-2 p-0">
              <p className="text-sm">
              ...
              <ul className="list-disc font-semibold list-inside space-y-1 text-xs">
